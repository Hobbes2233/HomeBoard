...
import { type BreakPoints, type BreakPointsWithXlg } from "./breakpoints";
...
export type ThemeProviderProps<T extends object> = ThemeStore["theme"] & {
  ...
  globalComponentStyles?: Partial<Record<string, CSSInterpolation>>;
...
export function ThemeProvider<T extends object>(props: ThemeProviderProps<T>) {
  return <InternalThemeProvider {...props} />;
}
